...
const joshua = createPerson("Joshua", "Joshua specializes in our sourdough. He makes and bakes all the bread the day before the Farmer’s Market. In addition to breads, Joshua has a master’s in philosophy and spends the school year teaching. He is currently working on learning web development.", joshuaPhoto);
const claire = createPerson("Claire", "Claire is our resident bagel expert and spends her time before the Farmer’s Market rolling and boiling bagel after bagel. Claire also crafts our granola and gets up early on the day of the Farmer's Market to make the brioche. She particularly enjoys our granola with vanilla ice cream. She is attending a master’s program in Ottawa.", clairePhoto);
